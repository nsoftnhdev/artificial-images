    ...
    <div className='flex items-center justify-between py-4'>
      ...
      <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
          <button onClick={() => navigate('/buy-credit')} className='flex items-center gap-2 bg-blue-200 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
          ...
          <div className='relative group'>
            <img src={assets.profile_icon} className='w-4 drop-shadow' alt="" />
